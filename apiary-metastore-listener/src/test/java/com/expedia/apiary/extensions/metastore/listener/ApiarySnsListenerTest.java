...
public class ApiarySnsListenerTest {
  ...
  public void onAlterTable() throws MetaException {
    ...
    verifyMessageAttributes(publishRequest,  "ALTER_TABLE", "new_" + TABLE_NAME);
  }

  private void verifyMessageAttributes(PublishRequest publishRequest, String eventType) {
    verifyMessageAttributes(publishRequest, eventType, TABLE_NAME);
  }

  private void verifyMessageAttributes(PublishRequest publishRequest, String eventType, String tableName) {
    ...
    assertThat(messageAttributes.get("dbName").getStringValue(), is(DB_NAME));
    assertThat(messageAttributes.get("tableName").getStringValue(), is(tableName));
