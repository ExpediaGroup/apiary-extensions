...
public class ApiarySnsListener extends MetaStoreEventListener {
  ...
  private Map<String, MessageAttributeValue> getMessageAttributes(EventType eventType, String dbName, String tableName) {
    Map<String, MessageAttributeValue> map = new HashMap<>();
    map.put("eventType", new MessageAttributeValue().withStringValue(eventType.toString()));
    map.put("dbName", new MessageAttributeValue().withStringValue(dbName));
    map.put("tableName", new MessageAttributeValue().withStringValue(tableName));
    return map;
  }
