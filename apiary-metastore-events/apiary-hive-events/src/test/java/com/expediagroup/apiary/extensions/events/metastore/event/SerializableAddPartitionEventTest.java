...
public class SerializableAddPartitionEventTest {
  ...
  private ApiaryAddPartitionEvent event;
  ...
  public void init() {
    ...
    event = new ApiaryAddPartitionEvent(addPartitionEvent);
  }
  ...
  public void nullPartitionIterator() {
    ...
    new ApiaryAddPartitionEvent(addPartitionEvent);
  }

  @Test
  public void emptyPartitionIterator() {
    when(addPartitionEvent.getPartitionIterator()).thenReturn(EMPTY_LIST.iterator());
    ApiaryAddPartitionEvent event = new ApiaryAddPartitionEvent(addPartitionEvent);
