...
public class SerializableDropPartitionEventTest {
  ...
  private ApiaryDropPartitionEvent event;
  ...
  public void init() {
    ...
    event = new ApiaryDropPartitionEvent(dropPartitionEvent);
  }
  ...
  public void nullPartitionIterator() {
    ...
    new ApiaryDropPartitionEvent(dropPartitionEvent);
  }

  @Test
  public void emptyPartitionIterator() {
    when(dropPartitionEvent.getPartitionIterator()).thenReturn(EMPTY_LIST.iterator());
    ApiaryDropPartitionEvent event = new ApiaryDropPartitionEvent(dropPartitionEvent);
