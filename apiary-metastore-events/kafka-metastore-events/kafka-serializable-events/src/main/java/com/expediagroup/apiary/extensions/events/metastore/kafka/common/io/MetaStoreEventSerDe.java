...
public interface MetaStoreEventSerDe {
  ...
  byte[] marshal(SerializableListenerEvent listenerEvent) throws SerDeException;

  <T extends SerializableListenerEvent> T unmarshal(byte[] payload) throws SerDeException;
