...
import static com.expediagroup.apiary.extensions.events.metastore.common.io.jackson.TestUtils.toJson;
...
public class SkewedInfoDeserializerTest {
  ...
  public void full() throws Exception {
    ...
    skewedInfo.setSkewedColValueLocationMaps(ImmutableMap
        ...
        .build());
    String json = toJson(skewedInfo);
    SkewedInfo si = mapper.readerFor(SkewedInfo.class).readValue(json);
    assertThat(si).isEqualTo(skewedInfo);
  }
