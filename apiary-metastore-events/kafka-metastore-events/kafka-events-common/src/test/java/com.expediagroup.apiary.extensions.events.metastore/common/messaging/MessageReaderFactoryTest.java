...
public class MessageReaderFactoryTest {
  ...
  public void classDoesNotImplementMessageReader() {
    expectedException.expect(KafkaMetaStoreEventsException.class);
  ...
  public void messageReaderClassNotFound() {
    ...
    MessageReaderFactory.newInstance("com.expediagroup.apiary.extensions.events.metastore"
      + ".common.messaging.UnknownMessageReaderFactory");
  }
