...
public class MskMessageSenderTest {
  ...
  public void populateKafkaPropertiesFromHadoop() {
    ...
    conf.set(SECURITY_PROTOCOL.key(), "SSL");
    conf.set(SASL_MECHANISM.key(), "AWS_MSK_IAM");
    conf.set(SASL_JAAS_CONFIG.key(), "software.amazon.msk.auth.iam.IAMLoginModule required;");
    conf.set(SASL_HANDLER_CLASS.key(), "software.amazon.msk.auth.iam.IAMClientCallbackHandler");
