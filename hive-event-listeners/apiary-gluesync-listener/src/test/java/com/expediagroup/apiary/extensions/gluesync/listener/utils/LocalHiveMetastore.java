...
/*
 * Apache Iceberg file to simulate a Hive metastore. Link (https://github.com/apache/iceberg/blob/c7ff6d51377eaae7f476e0c0730dea3b5a84fabb/hive-metastore/src/test/java/org/apache/iceberg/hive/TestHiveMetastore.java).
 */
...
public class LocalHiveMetastore {
  ...
  private static final DynConstructors.Ctor<HiveMetaStore.HMSHandler> HMS_HANDLER_CTOR = DynConstructors
      .builder()
  ...
  private static final DynMethods.StaticMethod GET_BASE_HMS_HANDLER = DynMethods
      .builder("getProxy")
  ...
  private static final DynMethods.StaticMethod METASTORE_THREADS_SHUTDOWN = DynMethods
      .builder("shutdown")
  ...
  public void start(HiveConf conf, int poolSize) {
    try {
      ...
      hiveConf = conf;
      server = newThriftServer(socket, poolSize, hiveConf);
      ...
      clientPool = new HiveClientPool(1, hiveConf);
    } catch (Exception e) {
