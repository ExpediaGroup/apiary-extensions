...
## [3.2.0] - TBD
### Added
- `apiary-metastore-events` module that contains `apiary-metastore-listener` and `apiary-recivers`
### Changed
- `apiary-metastore-listener` and `apiary-recivers` package paths were renamed from: `com.expediagroup.apiary.extensions` to: `com.expediagroup.apiary.extensions.events`
