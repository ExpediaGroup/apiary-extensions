...
public class Configuration {
    public static final String PATH_REPLACEMENT_PREFIX = "apiary.path.replacement";
    ...
    public static final String PATH_REPLACEMENT_GROUPS = format("%s.capturegroups", PATH_REPLACEMENT_PREFIX);
